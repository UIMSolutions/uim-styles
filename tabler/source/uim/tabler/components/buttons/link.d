...
unittest {
  ...
  assert(TABButtonLink(["a":"b"]) == `<a class="btn" role="button" a="b"></a>`);
  assert(TABButtonLink(["testclass"], ["a":"b"]) == `<a class="btn testclass" role="button" a="b"></a>`);
  ...
  assert(TABButtonLink(["a":"b"], "Hello") == `<a class="btn" role="button" a="b">Hello</a>`);
  assert(TABButtonLink(["testclass"], ["a":"b"], "Hello") == `<a class="btn testclass" role="button" a="b">Hello</a>`);
}
